...
//this kata is to split Rectangle into Squares, to split the largest Squares at first and then to the second largest square and so on.... 
...
//   if(lng > wdth){
//   	result.push(wdth);
//     sqInRect(lng-wdth, wdth, result);
//   }else{
//   	result.push(lng);
//   	sqInRect(wdth-lng, lng, result);
//   }
//   return result;
// }
